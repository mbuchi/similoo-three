...
export const RELEASES = [
  ...
  },
  {
    ...
    summary: 'similoo-three now type-checks on TypeScript 7 as its only compiler and lints with Oxlint instead of ESLint; production builds refuse to ship with type errors.',
    items: [
      {
        kind: 'improved',
        icon: 'zap',
        text: 'similoo-three now type-checks on TypeScript 7 as its only compiler and lints with Oxlint instead of ESLint; production builds refuse to ship with type errors. No change to what you see.',
        prs: [],
      },
    ],
  },
